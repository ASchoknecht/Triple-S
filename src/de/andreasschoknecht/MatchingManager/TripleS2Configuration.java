...
/**
 * The class TripleS2Configuration is responsible for the configuration of a Triple-S2 matcher.
 */
public class TripleS2Configuration implements MatcherConfiguration {

	/** The weights for a Triple-S2 matcher. */
	...
	/**
	 * Instantiates a new TripleS2 configuration.
	 *
	 ...
	 */
	public TripleS2Configuration(HashMap<String, Float> weights, String path, String output, String name) {
	...
	/* (non-Javadoc)
	 * @see de.andreasschoknecht.pnqmanager.ProcessModelMatchingManager.MatcherConfiguration#getWeights()
	 */
	@Override
